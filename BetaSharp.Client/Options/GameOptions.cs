...
public class GameOptions
{
    ...
    public string Language
    {
        ...
        set
        {
            ...
            Translations.UseLanguage(value);
        }
    }
    ...
    private void InitializeOptions()
    {
        ...
        {
            LabelOverride = Translations.GetFormatted("options.fps.maxFps"),
            Steps = 210,
            Formatter = (v) =>
            {
                int fps = 30 + (int)(v * 210.0f);
                return fps == 240 ? Translations.GetFormatted("options.fps.unlimited") : fps + " " + Translations.GetFormatted("options.fps.text");
            }
        };
        FovOption = new FloatOption("options.fov", "fov", 0.44444445F)
        {
            LabelOverride = Translations.GetFormatted("options.fov"),
            Steps = 90,
        ...
        {
            LabelOverride = Translations.GetFormatted("options.gamma"),
            Steps = 100,
        ...
        {
            LabelOverride = Translations.GetFormatted("options.vSync"),
        ...
        {
            Steps = 28,
            Formatter = (v) => $"{4 + (int)(v * 28.0f)} " + Translations.GetFormatted("options.renderDistance.chunks"),
            OnChanged = _ =>
            {
