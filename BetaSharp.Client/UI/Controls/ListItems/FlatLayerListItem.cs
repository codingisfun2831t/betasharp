...
public class FlatLayerListItem(FlatLayerInfo layer) : ListItem<FlatLayerInfo>(layer)
{
    ...
    public override void Render(UIRenderer renderer)
    {
        ...
        string blockName = block?.translateBlockName() ?? Translations.GetFormatted("newWorld.customize.unknown");
        ...
        renderer.DrawText(Translations.GetFormatted("newWorld.customize.height") + ": " + Value.LayerCount, 26, 16, Color.Gray80);
    }
}
