    ...
    WorldType currentType) : UIScreen(context)
{
    ...
    private void PopulateTypeList()
    {
        ...
        {
            type.SetDisplayName(Translations.GetFormatted($"selectWorld.type.{type.Name.ToLowerInvariant()}.title"))
                .SetDescription(Translations.GetFormatted($"selectWorld.type.{type.Name.ToLowerInvariant()}.description"));
