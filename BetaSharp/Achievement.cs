...
public class Achievement : StatBase
{
    ...
    public string? GetTranslatedTitle => Translations.GetFormatted($"{TranslationKey}.title");
    public string? GetTranslatedDescription => Translations.GetFormatted($"{TranslationKey}.desc");
